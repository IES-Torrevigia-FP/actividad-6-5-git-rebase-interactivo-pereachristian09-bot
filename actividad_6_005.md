...
Esta actividad incluye una evaluación automática similar a la de la actividad anterior, adaptada a rebase interactivo y limpieza de historial:
...
- `required_files` (por defecto: `app.md,cp1-historial-original.txt,cp2-reword.txt,cp3-squash.txt,cp4-reordenar.txt,cp5-abortar-rebase.txt,reflexion-6-5.md`)
